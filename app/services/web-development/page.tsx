...
import { ArrowRight, CheckCircle2, Code, Zap, Lock, BarChart3, Users, Globe } from "lucide-react"
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="container px-4 mx-auto relative z-10">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              <p className="text-primary font-medium tracking-wider">WEB DEVELOPMENT</p>
            </Reveal>
            <Reveal delay={0.1}>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mt-4 mb-6">
                <AnimatedText text="Scalable & High-Performance Websites" />
              </h1>
            </Reveal>
            <Reveal delay={0.2}>
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl">
                We create stunning, high-performance websites that drive business growth. From concept to deployment, we
                deliver digital experiences that engage and convert.
              </p>
            </Reveal>
            <Reveal delay={0.3}>
          ...
          <Reveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                We combine technical excellence with creative design to deliver web solutions that work as hard as you
                do.
              </p>
            </div>
          </Reveal>
        ...
        <div className="container px-4 mx-auto">
          <Reveal>
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold mb-12">Our Web Development Services</h2>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container px-4 mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <Reveal>
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Build Your Web Presence?</h2>
            </Reveal>
            <Reveal delay={0.1}>
